...
THREE.ThirdPersonControls = function ( object, domElement ) {
    ...
    this.update = function (delta) {
        ...
        //this.object.position.z +=  -( actualMoveSpeed + this.autoSpeedFactor );
        ...
        targetPosition.y = position.y +100000+ 100 * Math.cos(this.phi);
